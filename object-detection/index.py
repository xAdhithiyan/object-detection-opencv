...
net = cv2.dnn.readNet(r"dnn_model-220107-114215/dnn_model/yolov4-tiny.weights",r"dnn_model-220107-114215/dnn_model/yolov4-tiny.cfg")
...
#load class list
classes=[]
t = open(r"dnn_model-220107-114215/dnn_model/classes.txt") 
